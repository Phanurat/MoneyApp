<x-app-layout>
    ...
    <div class="card mx-auto" style="width: 90%; margin: 0 20%;">
        <div style="margin-top: 10px;"></div>
          <h4><b>รายการที่เหลือ: {{$value_count_not_zero}} ทั้งหมด: {{ $noincome_count }} รายการ
            <a href="{{route('add_no_income')}}" class="btn btn-warning" style="color: rgb(7, 41, 70); font-size:12px;"><button>เพิ่มค้างรับ</button>
            </a></b></h4>
          <h4><b>เงินทั้งหมด : 
